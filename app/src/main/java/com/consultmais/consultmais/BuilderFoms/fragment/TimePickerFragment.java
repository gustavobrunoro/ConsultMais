...
package com.consultmais.consultmais.BuilderFoms.fragment;
...
public class TimePickerFragment extends DialogFragment implements TimePickerDialog.OnTimeSetListener {
    ...
    public void onTimeSet(TimePicker view, int hour, int minute) {
        ...
        textView = (TextView) parentLayout.findViewWithTag("time");
    ...
    public void insereHora (){
        FormBuilder.inseriResposta(textView.getId(),textView.getText().toString(),false,10);
    }
}
